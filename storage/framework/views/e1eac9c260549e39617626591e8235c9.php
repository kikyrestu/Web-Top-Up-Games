...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .glow-1 { top: -100px; right: -50px; background: #f97316; }
        ...
        .error-code {
            ...
            background: linear-gradient(135deg, #f97316, #ff983f);
        ...
        .btn:hover { transform: translateY(-2px); box-shadow: 0 0 30px rgba(249,115,22,0.5); }
        .icon-wrap {
        ...
        .icon-wrap i { font-size: 2rem; color: #f97316; }
    </style>
</head>
<body>
    ...
    <div class="container">
        ...
        <h1>Akses Ditolak</h1>
        <p>Kamu tidak memiliki izin untuk mengakses halaman ini. Jika merasa ini kesalahan, silakan hubungi admin.</p>
        <a href="/" class="btn"><i class="fas fa-home"></i> Kembali ke Beranda</a>
    </div>
</body>
</html>
<?php /**PATH D:\PROJECT\webppobdantopup\resources\views/errors/403.blade.php ENDPATH**/ ?>