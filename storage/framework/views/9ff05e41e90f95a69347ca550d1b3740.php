...
<head>
    ...
    <meta name="csrf-token" content="<?php echo e(csrf_token()); ?>">
        <title><?php echo e($seoMetaTitle); ?></title>
        <meta name="description" content="<?php echo e($seoMetaDescription); ?>">
        <meta name="robots" content="<?php echo e($seoRobots); ?>">
        <link rel="canonical" href="<?php echo e($seoCanonical); ?>">
        <link rel="alternate" href="<?php echo e($seoCanonical); ?>" hreflang="id-ID">
        <link rel="alternate" href="<?php echo e($seoCanonical); ?>" hreflang="x-default">
        <link rel="alternate" type="application/rss+xml" title="<?php echo e($seoSiteName); ?> Feed" href="<?php echo e(route('front.feed')); ?>">

        <meta property="og:type" content="website">
        <meta property="og:locale" content="id_ID">
        <meta property="og:site_name" content="<?php echo e($seoSiteName); ?>">
        <meta property="og:title" content="<?php echo e($seoMetaTitle); ?>">
        <meta property="og:description" content="<?php echo e($seoMetaDescription); ?>">
        <meta property="og:url" content="<?php echo e($seoCanonical); ?>">
        <meta property="og:image" content="<?php echo e($seoImageUrl); ?>">
        <meta property="og:image:secure_url" content="<?php echo e($seoImageUrl); ?>">
        <meta property="og:image:alt" content="<?php echo e($seoMetaTitle); ?>">

        <meta name="twitter:card" content="summary_large_image">
        <meta name="twitter:title" content="<?php echo e($seoMetaTitle); ?>">
        <meta name="twitter:description" content="<?php echo e($seoMetaDescription); ?>">
        <meta name="twitter:image" content="<?php echo e($seoImageUrl); ?>">
        <meta name="twitter:image:alt" content="<?php echo e($seoMetaTitle); ?>">
        ...
        <div class="max-w-[1280px] mx-auto px-4">
            <div class="flex items-center justify-between h-16">
                ...
                <div class="flex items-center flex-1">
                    <a href="<?php echo e(route('front.index')); ?>" class="mr-8 flex items-center gap-2">
                        <?php if(!empty($global_site_logo)): ?>
                            <img src="<?php echo e(asset('storage/' . $global_site_logo)); ?>" alt="<?php echo e($global_site_name ?? 'Logo'); ?>" width="144" height="36" fetchpriority="high" decoding="async" class="h-9 w-auto object-contain">
                        <?php endif; ?>
                        <span class="text-white text-xl font-black tracking-tight flex items-center">
                            <?php echo e($global_site_name ?? 'PPOBKu'); ?>

                        </span>
                    </a>
                    
                    <nav class="hidden lg:flex space-x-6 text-xs font-bold text-gray-300">
                        <a href="<?php echo e(route('front.index')); ?>" class="text-white hover:text-up-yellow transition"><i class="fas fa-home mr-1"></i> Beranda</a>
                        <a href="<?php echo e(route('front.cek-pesanan')); ?>" class="hover:text-white transition"><i class="fas fa-search-dollar mr-1"></i> Cek Pesanan</a>
                        <a href="<?php echo e(route('front.page', 'daftar-harga')); ?>" class="hover:text-white transition"><i class="fas fa-list-alt mr-1"></i> Daftar Harga</a>
                        <a href="<?php echo e(route('front.article.index')); ?>" class="hover:text-white transition"><i class="fas fa-fire mr-1"></i> Promo & Acara</a>
                        ...
                        <div class="relative group" x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false">
                            ...
                            <div x-show="open" x-transition.opacity class="absolute top-full left-0 mt-4 w-48 bg-up-card border border-up-border rounded-lg shadow-xl py-2 z-50">
                                <a href="<?php echo e(route('front.page', 'kontak')); ?>" class="block px-4 py-2 text-gray-300 hover:text-up-yellow hover:bg-black/20 transition"><i class="fas fa-headset w-5"></i> Hubungi CS</a>
                                <a href="<?php echo e(route('front.page', 'syarat-ketentuan')); ?>" class="block px-4 py-2 text-gray-300 hover:text-up-yellow hover:bg-black/20 transition"><i class="fas fa-book-open w-5"></i> Syarat & Ketentuan</a>
                                <a href="<?php echo e(route('front.page', 'kebijakan-privasi')); ?>" class="block px-4 py-2 text-gray-300 hover:text-up-yellow hover:bg-black/20 transition"><i class="fas fa-shield-alt w-5"></i> Kebijakan Privasi</a>
                            </div>
                        </div>
                    </nav>
                </div>
                ...
                <div class="flex items-center space-x-4">
                    <form action="<?php echo e(route('front.index')); ?>" method="GET" class="hidden md:block relative">
                        <i class="fas fa-search absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 text-xs"></i>
                        <input type="text" name="q" value="<?php echo e(request('q')); ?>" placeholder="Cari produk, kategori, atau kode" class="bg-[#191d2c] border border-up-border text-white text-xs rounded-full pl-8 pr-4 py-2 w-64 focus:outline-none focus:border-up-yellow transition">
                    </form>
                    <a href="<?php echo e(route('login')); ?>" class="bg-up-yellow hover:bg-up-yellowhover text-black text-xs font-bold px-6 py-2 rounded shadow-sm transition">
                        MASUK
                    </a>
                </div>
        ...
        <div class="max-w-[1280px] mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
                <div class="md:col-span-2 space-y-6">
                    ...
                    <a href="<?php echo e(route('front.page', 'faq')); ?>" class="inline-block border border-up-border text-white text-sm px-6 py-2 rounded hover:bg-up-card transition">Lihat Semua</a>
                ...
                <div>
                    ...
                    <ul class="text-up-textmuted text-xs space-y-3">
                        <li><a href="<?php echo e(route('front.index')); ?>" class="hover:text-white transition">Game</a></li>
                        <li><a href="<?php echo e(route('front.index')); ?>" class="hover:text-white transition">Voucher</a></li>
                        <li><a href="<?php echo e(route('front.article.index')); ?>" class="hover:text-white transition">SEACA eSports & Community</a></li>
                        <li><a href="<?php echo e(route('front.page', 'daftar-harga')); ?>" class="hover:text-white transition">Saluran Pembayaran</a></li>
                    </ul>
                </div>
                <div>
                    <h4 class="text-white text-sm font-bold mb-6">Informasi dan Dukungan</h4>
                    <ul class="text-up-textmuted text-xs space-y-3">
                        <li><a href="<?php echo e(route('front.article.index')); ?>" class="hover:text-white transition">UP Station Media</a></li>
                        <li><a href="<?php echo e(route('front.article.index')); ?>" class="hover:text-white transition">Promo dan Acara</a></li>
                        <li><a href="<?php echo e(route('front.page', 'faq')); ?>" class="hover:text-white transition">FAQ</a></li>
                        <li><a href="<?php echo e(route('front.page', 'kontak')); ?>" class="hover:text-white transition">Dukungan Pelanggan</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="border-t border-up-border pt-6 flex flex-col md:flex-row justify-between items-center text-[10px] text-up-textmuted">
                <p>&copy; <?php echo e(date('Y')); ?> <?php echo e($global_site_name ?? 'PPOBKu'); ?>. Semua Hak Cipta | <a href="<?php echo e(route('front.page', 'syarat-ketentuan')); ?>" class="text-up-yellow hover:underline">Terms & Conditions</a> | <a href="<?php echo e(route('front.page', 'kebijakan-privasi')); ?>" class="text-up-yellow hover:underline">Privacy Policy</a></p>
            </div>
        </div>
    </footer>

    <!-- Floating WhatsApp -->
    <a href="<?php echo e($waLink); ?>" target="_blank" rel="noopener noreferrer" class="fixed bottom-6 right-6 w-14 h-14 bg-green-500 rounded-full flex items-center justify-center text-white shadow-lg hover:scale-110 transition z-50">
        <i class="fab fa-whatsapp text-3xl"></i>
    </a>

    <?php echo $__env->yieldPushContent('scripts'); ?>
</body>
</html><?php /**PATH D:\PROJECT\webppobdantopup\resources\views/layouts/front.blade.php ENDPATH**/ ?>