...
<?php $__env->startSection('header', 'Manajemen Kategori'); ?>

<?php $__env->startSection('content'); ?>
<div class="bg-gray-800 rounded-lg shadow-lg border border-gray-700 p-6">
    <div class="flex flex-col sm:flex-row justify-between items-center mb-6">
        <h2 class="text-xl font-semibold text-white mb-4 sm:mb-0">Daftar Kategori</h2>
        <a href="<?php echo e(route('admin.categories.create')); ?>" class="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded text-sm transition">
        ...
        <table class="w-full text-left border-collapse">
            <thead>
              ...
              <tbody id="sortable-categories">
                  ...
                  <tr class="border-b border-gray-700 hover:bg-gray-900/50 text-sm align-middle bg-gray-800" data-id="<?php echo e($category->id); ?>">
                      <td class="py-3 px-4">
                          <div class="flex items-center">
                              <i class="fas fa-grip-lines text-gray-500 cursor-move mr-3 hover:text-indigo-400 p-2"></i>
                              <span class="sort-number text-gray-400 font-mono"><?php echo e($index + 1); ?></span>
                          </div>
                      </td>
                    <td class="py-3 px-4">
                        <?php if($category->thumbnail): ?>
                            <img src="<?php echo e(Storage::url($category->thumbnail)); ?>" alt="<?php echo e($category->name); ?>" class="h-12 w-12 object-cover rounded shadow border">
                    ...
                    <td class="py-3 px-4">
                        <div class="font-bold text-white"><?php echo e($category->name); ?></div>
                        <div class="text-xs text-gray-400"><?php echo e($category->publisher ?? 'No Publisher'); ?></div>
                    </td>
                    <td class="py-3 px-4">
                        <div class="flex gap-1 flex-wrap">
                            ...
                            <?php endif; ?>
                            <?php if(!$category->is_popular && !$category->is_new): ?>
                    ...
                    <td class="py-3 px-4 text-center flex justify-center space-x-3 items-center pt-5 border-t-0">
                        <a href="<?php echo e(route('admin.categories.edit', $category->id)); ?>" class="text-blue-500 hover:text-blue-700 transition" title="Edit">
                            <i class="fas fa-edit text-lg"></i>
                        </a>
                        <form action="<?php echo e(route('admin.categories.destroy', $category->id)); ?>" method="POST" onsubmit="return confirm('Yakin ingin menghapus kategori ini beserta gambar thumbnail-nya?');" class="inline">
                            <?php echo csrf_field(); ?>
                ...
                <tr>
                    <td colspan="6" class="py-6 px-4 text-center text-gray-400 italic">Belum ada kategori yang ditambahkan. <a href="<?php echo e(route('admin.categories.create')); ?>" class="text-blue-500 font-bold hover:underline">Tambah Kategori</a></td>
                </tr>
                <?php endif; ?>
            </tbody>
        </table>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT\webppobdantopup\resources\views/admin/categories/index.blade.php ENDPATH**/ ?>