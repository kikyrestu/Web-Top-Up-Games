...
<div class="flex justify-center w-full"><div class="w-full max-w-3xl"><div class="glass-panel rounded-2xl shadow-xl border border-dark-700 p-6 sm:p-8 mb-8 relative overflow-hidden w-full">
    ...
    <form action="<?php echo e(route('admin.products.store')); ?>" method="POST" enctype="multipart/form-data" class="relative z-10">
        <?php echo csrf_field(); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" name="name" id="name" value="<?php echo e(old('name')); ?>" class="w-full pl-10 pr-4 py-2.5 bg-dark-800 border border-dark-600 text-white rounded-xl focus:outline-none focus:border-brand-500 focus:ring-1 focus:ring-brand-500 transition-all shadow-inner" placeholder="Misal: Diamond Mobile Legends" required>
                </div>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="number" name="price_capital" id="price_capital" value="<?php echo e(old('price_capital', 0)); ?>" class="w-full pl-14 pr-4 py-2.5 bg-dark-800 border border-dark-600 text-white rounded-xl focus:outline-none focus:border-brand-500 focus:ring-1 focus:ring-brand-500 transition-all shadow-inner font-mono" required>
                </div>
            </div>
        ...
        <div class="mb-5">
            ...
            <textarea name="description" id="description" rows="3" class="w-full p-3 bg-dark-800 border border-dark-600 text-white rounded-xl focus:outline-none focus:border-brand-500 focus:ring-1 focus:ring-brand-500 transition-all shadow-inner placeholder-gray-600" placeholder="Deskripsi atau catatan untuk produk ini (opsional)..."><?php echo e(old('description')); ?></textarea>
        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PROJECT\webppobdantopup\resources\views/admin/products/create.blade.php ENDPATH**/ ?>