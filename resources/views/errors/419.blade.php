...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .glow-1 { top: -100px; right: -50px; background: #f59e0b; }
        ...
        .icon-wrap i { font-size: 2rem; color: #f59e0b; }
    </style>
</head>
<body>
    ...
    <div class="container">
        ...
        <p>Halaman ini sudah terlalu lama terbuka. Silakan refresh halaman atau kembali ke beranda untuk melanjutkan.</p>
        <a href="/" class="btn"><i class="fas fa-redo"></i> Muat Ulang</a>
    </div>
</body>
</html>
