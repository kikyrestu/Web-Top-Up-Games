        ...
        <div class="mb-4 border border-gray-600 rounded-lg p-4 bg-gray-900/50">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="commission_value" value="{{ old('commission_value') }}" placeholder="Contoh: 5 untuk 5% atau 500" class="w-full px-3 py-2 bg-gray-700 border-gray-600 text-white rounded focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 text-sm">
                </div>
            </div>
        </div>
