            ...
            <div class="flex items-center justify-between gap-4">
                ...
                <nav class="hidden lg:flex items-center gap-1 flex-1 justify-center" x-data="{ moreOpen: false }">
                    ...
                    <div class="relative" @mouseenter="moreOpen = true" @mouseleave="moreOpen = false">
                        ...
                        <div x-show="moreOpen" x-transition:enter="transition ease-out duration-150" x-transition:enter-start="opacity-0 -translate-y-1" x-transition:enter-end="opacity-100" x-transition:leave="transition ease-in duration-100" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0 -translate-y-1" class="absolute left-1/2 -translate-x-1/2 top-full mt-2 w-64 bg-up-card border border-up-border rounded-xl shadow-2xl py-2 z-50 whitespace-nowrap" style="display: none;">
                            <a href="{{ route('front.calculator') }}" class="flex items-center gap-3 px-5 py-2.5 text-[14px] text-gray-300 hover:text-up-yellow hover:bg-black/20 transition"><i class="fas fa-calculator w-5 text-center text-gray-500"></i> Kalkulator</a>
                            <a href="{{ route('front.page', 'kontak') }}" class="flex items-center gap-3 px-5 py-2.5 text-[14px] text-gray-300 hover:text-up-yellow hover:bg-black/20 transition"><i class="fas fa-headset w-5 text-center text-gray-500"></i> Hubungi CS</a>
                            <div class="border-t border-up-border/40 my-2"></div>
                            <a href="{{ route('front.page', 'syarat-ketentuan') }}" class="flex items-center gap-3 px-5 py-2.5 text-[14px] text-gray-300 hover:text-up-yellow hover:bg-black/20 transition"><i class="fas fa-book-open w-5 text-center text-gray-500"></i> Syarat & Ketentuan</a>
                            <a href="{{ route('front.page', 'kebijakan-privasi') }}" class="flex items-center gap-3 px-5 py-2.5 text-[14px] text-gray-300 hover:text-up-yellow hover:bg-black/20 transition"><i class="fas fa-shield-alt w-5 text-center text-gray-500"></i> Kebijakan Privasi</a>
                        </div>
                    </div>
                </nav>
