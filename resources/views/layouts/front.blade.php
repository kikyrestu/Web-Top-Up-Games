            ...
            <div class="flex items-center justify-between gap-4">
                ...
                <nav class="hidden lg:flex items-center gap-1 flex-1 justify-center" x-data="{ moreOpen: false }">
                    ...
                    <div class="relative" @mouseenter="moreOpen = true" @mouseleave="moreOpen = false">
                        ...
                        <div x-show="moreOpen" x-transition:enter="transition ease-out duration-150" x-transition:enter-start="opacity-0 -translate-y-1" x-transition:enter-end="opacity-100" x-transition:leave="transition ease-in duration-100" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0 -translate-y-1" class="absolute left-1/2 -translate-x-1/2 top-full mt-2 w-[220px] bg-up-card border border-up-border rounded-xl shadow-2xl py-1.5 z-50 whitespace-nowrap" style="display: none;">
